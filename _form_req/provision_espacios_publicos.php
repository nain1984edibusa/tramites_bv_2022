    ...
    <div class="container-flat-form">
        ...
        <form enctype="multipart/form-data" method="post" class="form-padding" action="controller/registrar_tramite.php" autocomplete="off">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="group-material">
                        ...
                        <textarea id="tema" name="tema" class="tooltips-general material-control" placeholder="Escriba el tema del evento" required="" data-toggle="tooltip" data-placement="top" title="Escribe el nombre de la Institución"></textarea>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-6">
                    <div class="group-material">
                        <input id="aforo" name="aforo" type="text" class="tooltips-general material-control" placeholder="Escriba el aforo aproximado" required="" data-toggle="tooltip" data-placement="top" title="Escriba el aforo aproximado">
                        <span class="highlight"></span>
                        <span class="bar"></span>
                ...
                <div class="col-xs-12 col-sm-12 col-md-6">
                    <div class="group-material">
                        <input id="duracion" name="duracion" type="text" class="tooltips-general material-control" placeholder="Escriba la duración aproximada" required="" data-toggle="tooltip" data-placement="top" title="Escriba la duración aproximada">
                        <span class="highlight"></span>
                        <span class="bar"></span>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="group-material">
                        <input id="persona_acargo" name="persona_acargo" type="text" class="tooltips-general material-control" placeholder="Escriba el nombre de la persona a cargo del evento"  data-toggle="tooltip" data-placement="top" title="Escriba el nombre de la persona a cargo del evento">
                        <span class="highlight"></span>
                        <span class="bar"></span>
            ...
            <div class="row margensup">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6">
                    <div class="group-material">
                        <input id="fecha1" name="fecha1" type="date" class="tooltips-general material-control" placeholder="Escoge la fecha" pattern="[0-9]{1,20}"  maxlength="20" data-toggle="tooltip" data-placement="top" title="Escoga la fecha">
                        <span class="highlight"></span>
                        <span class="bar"></span>
