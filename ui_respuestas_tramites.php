      ...
      <td><span class="small"><?php echo $ttramite["et_nombre"] */ ?></span></td>
        ...
        <div class="container-flat-form formularios_ct">
            ...
            while ($anexo = mysqli_fetch_array($tanexos)) {
                if ($anexo["anx_requerido"] == "SI"): $numarequeridos += 1;
                endif;
                ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6">
                                <div class="group-material">
                                    ...
                                    <?php
                                    if (($anexo["tu_id"] == $tu_id) && ($anexo["tua_rutaarchivo"] != NULL)) {
                                        $numanexos += 1;
                                        ?>
                                        <p class="respuesta">
                ...
                <?php if ($anexo["tua_cumple"] == "CORRECTO") { ?>
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="group-material">
                            <?php
                            if (($anexo["tu_id"] == $tu_id) && ($anexo["tua_rutaarchivo"] != NULL)) {
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6">
                            <div class="group-material">
                                ...
                                <?php
                                if (($_GET["idt"] == 12)or($_GET["idt"] == 16)) {
                                    ?>
                                    <input type="hidden" id="tipo_contestacion" name="tipo_contestacion" value="AFIRMATIVO" />
                                    <?php
                                } else {
                                    ?>
                                    ...
                                    <select id="tipo_contestacion" name="tipo_contestacion" class="tooltips-general material-control" data-toggle="tooltip" data-placement="top" required="">
                                        ...
                                        <option <?php
                                        if ($tipo_contestacion == "AFIRMATIVO"): echo "selected";
                                        endif
                                        ?>  value="AFIRMATIVO">AFIRMATIVO</option>
                                        <option <?php
                                        if ($tipo_contestacion == "NEGATIVO"): echo "selected";
                                        endif
