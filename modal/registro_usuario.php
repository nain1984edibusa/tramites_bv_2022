                ...
                <div class="modal-body">
                    ...
                    <div id="divRuc" class="row" style="display:none">
                        <div class="col-xs-12 col-sm-12">
                            <div class="group-material">
                                <input id="razon_social" name="razon_social" type="text" class="tooltips-general material-control" placeholder="Por ejemplo: Carlos Manuel"  maxlength="70" data-toggle="tooltip" data-placement="top" onKeyUp="this.value = this.value.toUpperCase();"> <!--title="Escriba sus nombres completos"--> 
                                <span class="highlight"></span>
                                <span class="bar"></span>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 checkbox">
                            <div class="group-material">
                                ...
                                <label for="checkbox2">Al registrarme, acepto el <a href="#" data-toggle="modal" data-target="#ModalAcuerdoResponsabilidad">acuerdo de confidencialidad y responsabilidad</a></label> 
                            </div>
                        </div>
                    </div>
                </div>
