...
if($respuesta["tuc_tipocontestacion"]=="AFIRMATIVO"){
    $tresp="se han <b>VALIDADO</b> las <b>".$tespecifico["te_cantidad_fichas"]."</b> Fichas de Inventario enviadas, conforme lo indica el informe técnico que se adjunta.";
}elseif($respuesta["tuc_tipocontestacion"]=="NEGATIVO"){
    $tresp="se han encontrado <b>ERRORES</b> durante el proceso de validación en las <b>".$tespecifico["te_cantidad_fichas"]."</b> Fichas de Inventario enviadas. Los detalles se describen en el informe técnico adjunto.";
}else{
    $tresp="<b>NO</b> se han <b>VALIDADO ".$respuesta["tuc_fichas_nvalidadas"]."</b> de las <b>".$tespecifico["te_cantidad_fichas"]."</b> Fichas de Inventario enviadas. Los detalles se describen en el informe técnico adjunto.";
}
