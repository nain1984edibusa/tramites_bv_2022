...
$contenido_respuesta.="<p>El Instituto Nacional de Patrimonio Cultural del Ecuador (INPC) pone en su conocimiento que:</p><p>Una vez que la Dirección de Control Técnico, Conservación y Salvaguardia del Patrimonio Cultural, ha brindado el asesoramiento técnico y/o asistencia correspondiente al trámite ingresado y ha procedido a realizar el análisis respectivo sobre el tema: ".$tema.", <b>".$tespecifico["te_ficha_inventario"]."</b>, ".$tresp."</p>";
