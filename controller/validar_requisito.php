...
switch ($id_tramite) {
    ...
    case "8": $clste = new clstramite8();
        $req = 1;
        break; //1=TIENEN REQUISITOS 0=NO TIENEN REQUISITOS
    case "12": $clste = new clstramite12();
        $req = 1;
        break;
    case "13": $clste = new clstramite13();
        $req = 1;
        break;
    case "16": $clste = new clstramite16();
        $req = 0;
        break;
    case "17": $clste = new clstramite17();
        $req = 0;
        break;
    case "18": $clste = new clstramite18();
        $req = 0;
        break;
}
