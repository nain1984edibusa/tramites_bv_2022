    ...
    //elseif($_POST["banderaReg"] == 0){ // si la bandera es 0 simplemente actualizamos el usuario
        ...
        if($clsusu->usu_actualizarData() == 1){
            ...
            if($clsusu->getRol_id() == 4) // Caso que sea ciudadano regresa a su menu asignado
                echo '<script language="javascript">window.location.href="https://tramites.patrimoniocultural.gob.ec/tramites_bv/ue_home.php";</script>';
            else
                echo '<script language="javascript">window.location.href="https://tramites.patrimoniocultural.gob.ec/tramites_bv/ui_home.php";</script>';
