...
switch ($_SESSION["codperfil"]) {
    case ASIGNADOR: $nuevo_estado = ANALISIS_SOLICITUD;
        $redireccion = "ui_bandeja_recibidos";
        break;
    case EJECUTOR: $nuevo_estado = CONTESTADO_REVISION;
        $redireccion = "ui_bandeja_revision";
        break;
    case APROBADOR: $nuevo_estado = CONTESTADO_REVISION;
        $redireccion = "ui_bandeja_revision";
        break;
