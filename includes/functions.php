...
function denominacion_identificador($tidentificador){
    ...
    switch ($tidentificador){
        case "CI": $result="de la cédula de ciudadanía Nro."; break;
        case "RUC": $result="del RUC"; break;
        case "PASAPORTE": $result="del pasaporte Nro."; break;
    }
    return $result;
}
/*add*/
//funcion que permite extraer los dias laborables para el ingreso de los feriados 
