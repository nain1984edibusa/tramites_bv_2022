...
/*Presenta mensajes de alerta, de acuerdo a los parámetros enviados mediante redireccionamiento */
    if(isset($_GET["proc"])):
	    ...
	    case "recpsswd": // RECUPERACION DE CLAVE DE ACCESO
		     if($_GET["est"]=="0"){?>
                	<div class="alert alert-danger">
                   	 <strong>Error:</strong> Debe registrarse para poder ingresar al sistema.
           	 <?php
           	 }
           	 if($_GET["est"]=="1"){?>
                	<div class="alert alert-success">
                   	 <strong>Información:</strong> Revise su buzón de correo electrónico.
           	 <?php
           	 }
       	     break;	
        }?>
