...
$opcion="Certificación de bienes culturales NO patrimoniales para salida al Exterior";
...
<div class="container-fluid">
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 text-justify lead">
            Bienvenido a esta sección, le permita registrar los objetos a certificarse.
        </div>
    </div>
</div>
<div class="container-fluid">
