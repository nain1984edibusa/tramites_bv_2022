...
Class clstramite17 extends clstramiteusuario {
    ...
    private $tu_caracteristicas_bien;

    public function getCaracteristicas_bien() {
        return $this->tu_caracteristicas_bien;
    }

    public function setCaracteristicas_bien($tu_caracteristicas_bien): void {
        $this->tu_caracteristicas_bien = $tu_caracteristicas_bien;
    }
