...
Class clstramite18 extends clstramiteusuario{
 ...
 public function tu_insertar(){
        ...
        $bd->carga_campos("tu_codigo,usu_extid,usu_intid,tra_id,tu_fecha_ingreso,tu_fecha_contcont,tu_fecha_aprocont,reg_id,et_id,te_institucion,te_evento,te_tema,te_aforo,te_duracion,te_persona_acargo,te_fecha1,te_hora"); // campos a ser insertados
